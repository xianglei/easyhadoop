...
<html lang="<?php echo $common_lang_set;?>">
  <head>
	...
	<script type="text/javascript" src="<?php echo $this->config->base_url();?>js/jquery.jstree.js"></script>
	<link type="text/css" rel="stylesheet" href="<?php echo $this->config->base_url();?>css/syntax/!style.css"/>
	<!--<!<link type="text/css" rel="stylesheet" href="<?php echo $this->config->base_url();?>css/!style.css"/>-->
	<script type="text/javascript" src="<?php echo $this->config->base_url();?>css/syntax/!script.js"></script>	
