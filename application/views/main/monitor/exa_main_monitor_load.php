...
{
	$.getJSON('<?php echo $this->config->base_url();?>index.php/monitor/loadstats/' + host_id, function(json){
	...
	<br />
	<div class="progress">
		<div class="progress-bar progress-bar-info" style="" id="sample_1load">1 min LoadAvg</div>
		<div class="progress-bar progress-bar-warning" style="" id="sample_5load">5 min LoadAvg</div>
		<div class="progress-bar progress-bar-danger" style="" id="sample_15load">15 min LoadAvg</div>
	</div>
	<script>
	function sample()
	{
	...
	<tbody>
		...
		<tr>
			...
			<td id="last_pid_<?php echo $item->id;?>"></td>
			<td>
			<div class="progress">
				<div class="progress-bar progress-bar-info" id="load1_<?php echo $item->id;?>" style=""></div>
				<div class="progress-bar progress-bar-warning" id="load5_<?php echo $item->id;?>" style=""></div>
				<div class="progress-bar progress-bar-danger" id="load15_<?php echo $item->id;?>" style=""></div>
			</div>
			<script>
			
			host_load(<?php echo $item->id;?>);
