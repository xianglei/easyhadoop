  <div class="modal fade" id="create_nodes_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog"><form method="POST" action="<?php echo $this->config->base_url();?>index.php/nodes/createnodes/">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title"><?php echo $common_nodes_create_nodes;?></h4>
        </div>
        <div class="modal-body">
			...
			<tr>
				...
				<td><textarea name="ipaddr" placeholder="Each IP per line" class="form-control" cols="10" rows="5"></textarea></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" name="ssh_user" placeholder="root"  class="form-control" disabled />
