...
$config['hbase_conf_folder'] = '/etc/hbase/';
$config['hive_conf_folder'] = '/etc/hive/';
$config['pig_conf_folder'] = '/etc/pig';
$config['zookeeper_conf_folder'] = '/etc/zookeeper';
$config['agent_path'] = '/usr/local/exadoop/';
...
$config['agent_filename'] = 'NodeAgent-1.2.1';
$config['bin_el6_filename'] = 'centos_6.bin';
$config['bin_el5_filename'] = 'centos_5.bin';
$config['bin_ubuntu_filename'] = 'ubuntu.bin';
