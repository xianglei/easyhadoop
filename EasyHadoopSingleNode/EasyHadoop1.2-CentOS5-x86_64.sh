...
if [ $TYPE = "S" ]; then
	rpm -ivh jdk-7u7-linux-x64.rpm lzo-2.06-1.el5.rf.x86_64.rpm lzo-devel-2.06-1.el5.rf.x86_64.rpm hadoop-gpl-packaging-0.5.4-1.x86_64.rpm hadoop-1.0.3-1.x86_64.rpm
